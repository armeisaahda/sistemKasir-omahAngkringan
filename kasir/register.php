...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($check_user) > 0) {
        ...
        $insert = "INSERT INTO users (username, password, email, role, nama, nama_perusahaan, registered_at) 
                   VALUES ('$username', '$hashed_password', '$email', 'admin', '$nama', '$nama_perusahaan', NOW())";
                                ...
                                <div class="row gy-2 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" placeholder="Email" requ ired>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <label for="nama_perusahaan" class="form-label" style="color: black;">Nama Perusahaan</label>
                                    ...
                                    <div class="col-12">
                                        <p class="m-0 text-secondary text-center">Sudah Mempunyai Akun? <a href="login.php" class="link-primary text-decoration-none">Login Disini</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
