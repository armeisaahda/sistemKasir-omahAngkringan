...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($file['tmp_name'], $imagePath)) {
        $query = "INSERT INTO produk (nama, harga, kategori, gambar) VALUES ('$nama', '$harga', '$kategori', '$imagePath')";
...
if (isset($_POST['edit'])) {
    ...
    if ($file['tmp_name']) {
        ...
        $query = "UPDATE produk SET nama = '$nama', harga = '$harga', kategori = '$kategori', gambar = '$imagePath' WHERE id = '$id_produk'";
    } else {
        $query = "UPDATE produk SET nama = '$nama', harga = '$harga', kategori = '$kategori' WHERE id = '$id_produk'";
    }
                ...
                <div class="container-fluid">
                    <div class="mb-3">
                        <p>
                            <a class="btn bg-black text-yellow" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fas fa-plus-square"></i> Tambah Data Produk
                            </a>
                        </p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-yellow">Data Produk</h6>
                        </div>
                        <div class="card-body">
